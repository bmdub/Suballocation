...
{
    public class NativeDictionaryTreeTests
    {
        [Test]
        [TestCase(1)]
        [TestCase(64)]
        [TestCase(65)]
        public void RetrievalTest(long elementsPerTable)
        {
            var dict = new NativeDictionaryTree<long>(elementsPerTable: elementsPerTable);
