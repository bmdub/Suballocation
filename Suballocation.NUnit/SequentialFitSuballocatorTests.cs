...
{
    public class SequentialFitSuballocator
    {
        public void Constructor1Test()
        {
            var allocator = new SequentialFitSuballocator<int>(1024);
        ...
        public unsafe void Constructor2Test()
        {
            ...
            var allocator = new SequentialFitSuballocator<int>(pElems, 1024);
        ...
        public void Constructor3Test()
        {
            ...
            var allocator = new SequentialFitSuballocator<int>(mem);
        ...
        {
            var allocator = new SequentialFitSuballocator<int>(32640);
        ...
        public void BoundaryTest()
        {
            ...
            var allocator = new SequentialFitSuballocator<int>(length);
